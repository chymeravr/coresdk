...
void RendererNoHMDStereo::drawLeft(Scene *scene) { drawScene(scene); }
void RendererNoHMDStereo::drawRight(Scene *scene) { drawScene(scene); }

void RendererNoHMDStereo::drawScene(Scene *scene) {
  IRenderable *sceneRenderer = scene->getRenderable();
