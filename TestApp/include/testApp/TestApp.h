...
namespace cl{
    ...
    class TestApp : public EventKeyPressListener, public EventPassiveMouseMotionListener{
    public:
        TestApp(std::unique_ptr<IRenderer> renderer, std::unique_ptr<ISceneFactory> sceneFactory, std::unique_ptr<IModelFactory> modelFactory, std::unique_ptr<IDiffuseTextureFactory> diffuseTextureFactory,
