...
namespace cl {
TextureTextGL::TextureTextGL(const std::string &sceneId,
...
IRenderable *TextureTextGL::getRenderable() { return this; }
...
void TextureTextGL::draw() { glBindTexture(GL_TEXTURE_2D, textureId); }
void TextureTextGL::deinitialize() { glDeleteTextures(1, &textureId); }
}