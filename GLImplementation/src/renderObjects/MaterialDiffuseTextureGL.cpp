...
namespace cl {
MaterialDiffuseTextureGL::MaterialDiffuseTextureGL(
    const std::string &sceneId, ShaderDiffuseTextureGL *shader,
    ILoggerFactory *loggerFactory)
    : MaterialDiffuseTexture(sceneId, shader, loggerFactory) {
  logger = loggerFactory->createLogger(
      "glImplementation::MaterialDiffuseTextureGL: ");
}

IRenderable *MaterialDiffuseTextureGL::getRenderable() { return this; }

void MaterialDiffuseTextureGL::setDiffuseTextureId(
