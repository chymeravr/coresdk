...
namespace cl{
    ShaderDiffuseTextureGL::ShaderDiffuseTextureGL(const std::string &sceneId, ILoggerFactory *loggerFactory, Scene *scene):ShaderDiffuseTexture(sceneId, loggerFactory, scene){
