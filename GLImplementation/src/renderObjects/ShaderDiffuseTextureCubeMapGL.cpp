...
namespace cl{
    ShaderDiffuseTextureCubeMapGL::ShaderDiffuseTextureCubeMapGL(const std::string &sceneId, ILoggerFactory *loggerFactory, Scene *scene) :ShaderDiffuseTextureCubeMap(sceneId, loggerFactory, scene){
