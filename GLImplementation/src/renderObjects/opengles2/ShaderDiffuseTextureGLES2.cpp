...
namespace cl
{
ShaderDiffuseTextureGLES2::ShaderDiffuseTextureGLES2(const std::string &sceneId, ILoggerFactory *loggerFactory,
...
IRenderable *ShaderDiffuseTextureGLES2::getRenderable()
{
    return this;
}
/*
		...
		*/
bool ShaderDiffuseTextureGLES2::initialize()
{
    ...
    {
	MaterialDiffuseTextureGLES2 *material = (MaterialDiffuseTextureGLES2 *)(*it);
...
void ShaderDiffuseTextureGLES2::draw()
{
    glUseProgram(programId);
    cameraGLContainer->draw();
}
void ShaderDiffuseTextureGLES2::deinitialize()
{
