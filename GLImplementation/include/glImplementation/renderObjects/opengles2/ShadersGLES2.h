...
namespace cl
{
const std::string uniformColorGlVertexShader = "// Input vertex data, different for all executions of this shader.\n"
...
const std::string diffuseTextureGlVertexShader = "// Input vertex data, different for all executions of this shader.\n"
						 "attribute vec3 vertexPosition_modelspace;\n"
...
const std::string diffuseTextureGlFragmentShader = "precision mediump float; \n"
...
const std::string diffuseTextureCubeMapGlFragmentShader = "#version 200 es \n"
							  "precision mediump float; \n"
							  "in vec3 texCoord;\n"
							  "out vec4 color; \n"
