...
namespace cl{
	const std::string uniformColorGlVertexShader = "#version 300 es\n"
	...
	const std::string uniformColorGlFragmentShader =  "#version 300 es \n"
			"// Ouput data\n"
    ...
    const std::string diffuseTextureGlVertexShader =  "#version 300 es\n"
			"// Input vertex data, different for all executions of this shader.\n"
			"layout(location = 0) in vec3 vertexPosition_modelspace;\n"
    ...
    const std::string diffuseTextureGlFragmentShader = "#version 300 es \n"
			"precision mediump float; \n"
    ...
    const std::string diffuseTextureCubeMapGlVertexShader = "#version 300 es\n"
    ...
    const std::string diffuseTextureCubeMapGlFragmentShader = "#version 300 es \n"
			"precision mediump float; \n"
			"in vec3 texCoord;\n"
			"out vec4 color; \n"
