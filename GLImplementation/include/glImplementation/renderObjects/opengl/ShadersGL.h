...
namespace cl{
	const std::string uniformColorGlVertexShader = "#version 330 core\n"
		...
		"}\n";
	const std::string uniformColorGlFragmentShader = "#version 330 core \n"
		"// Ouput data\n"
		"out vec4 color;\n"
		"// Values that stay constant for the whole mesh.\n"
    ...
    const std::string diffuseTextureGlVertexShader = "#version 330 core\n"
			"// Input vertex data, different for all executions of this shader.\n"
			"layout(location = 0) in vec3 vertexPosition_modelspace;\n"
    ...
    const std::string diffuseTextureGlFragmentShader = "#version 330 core \n"
    ...
    const std::string diffuseTextureCubeMapGlVertexShader = "#version 330\n"
    ...
    const std::string diffuseTextureCubeMapGlFragmentShader = "#version 330 \n"
			"in vec3 texCoord;\n"
			"out vec4 color; \n"
