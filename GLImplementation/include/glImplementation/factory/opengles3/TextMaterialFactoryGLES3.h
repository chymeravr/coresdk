...
class TextMaterialFactoryGLES3 : public ITextMaterialFactory
{
  public:
	...
	return std::unique_ptr<TextureText>(new TextureTextGLES3(sceneId, loggerFactory, width, height, std::move(data)));
    }
    ...
    {
	return std::unique_ptr<MaterialText>(new MaterialTextGLES3(sceneId, (ShaderTextGLES3 *)shaderText, (TextureTextGLES3 *)textureText, loggerFactory));
    }
