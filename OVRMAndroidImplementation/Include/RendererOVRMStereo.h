...
#ifndef ANDROIDIMPLEMENTATION_RENDEREROVRMSTEREO_H
#define ANDROIDIMPLEMENTATION_RENDEREROVRMSTEREO_H
...
class RendererOVRMStereo : public IRenderer
{
  ...
  public:
    RendererOVRMStereo(JNIEnv *env, jobject activityObject, ILoggerFactory *loggerFactory);
    bool start();
...
#endif //ANDROIDIMPLEMENTATION_RENDEREROVRMSTEREO_H
