...
//        GL( glClearColor( 0.625f, 0.4f, 0.325f, 1.0f ) );
...
//            GL( glClearColor( 0.60f, 0.4f, 0.3f, 1.0f ) );
//            // bottom
...
//================================================================================
//*/
////#define MULTI_THREADED ALOGV("MultiThreaded Enabled")
//
//#if MULTI_THREADED
//
//typedef enum
...
//{
//    *(void **)&message->Parms[index] = ptr;                                                         // cast message pointer pointer to void pointer pointer and set value
//}
...
//    (*java.Vm)->AttachCurrentThread(java.Vm, &java.Env, NULL);                                      // attaching the JVM to the ovrAppThread - we need java
//    java.ActivityObject = appThread->ActivityObject;
//
//    // Note that AttachCurrentThread will resset the thread name.
//    prctl(PR_SET_NAME, (long) "OVR::Main", 0, 0, 0);
//
//    const ovrInitParms initParms = vrapi_DefaultInitParms(&java);                                   // i guess you have to pass this to java
//    int32_t initResult = vrapi_Initialize(&initParms);                                              // i guess then you initialize the vrapi
...
//    perfParms.CpuLevel = CPU_LEVEL;                                                                 // prevent cpu / gpu overheating
//    perfParms.GpuLevel = GPU_LEVEL;                                                                 // prevent cpu / gpu overheating
...
//        }
//
//        // Create the scene if not createdyet.
...
//        }
//
//        // This is the only place the frame index is incremented, right vefore
//        // calling vrapi_GetPreditedDisplayTime().
//        appState.FrameIndex++;
//
//        // Get the HMD pose, predicted for the middle of the time period during which
//        // the new eye images will be displayed. The number of frames predicted ahead
//        // depends on the pipeline depth of the engine and the synthesis rate.
//        // The better the prediction, the less black will be pulled in at thge esges.
...
////		ALOGE( "pthread_create returned %i", createErr );
////	}
//    (*env)->GetJavaVM( env, &appThread->JavaVm);            // returns an int which can be checked for errors
//    appThread->ActivityObject = (*env)->NewGlobalRef( env, activityObject);     // this is how you attach a global reference to a jobject
...
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onCreateNative( JNIEnv * env, jobject obj, jobject activity, jobject assetManager )
//{
...
//    ovrAppThread* appThread = (ovrAppThread*)malloc( sizeof( ovrAppThread) );                       // allocate memory for an ovrAppThread
//    ovrAppThread_Create(appThread, env, activity);                                                  // Initialize ovr app thread - javavm, activityobject, window, thread, messagequeue
//
...
//    ovrMessageQueue_PostMessage( &appThread->MessageQueue, &message );
//
//    return (jlong)((size_t)appThread);                                                              // size_t holds the size of an object  - jlong gives back the pointer to it
//
//}
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onStartNative( JNIEnv * env, jobject obj, jlong handle )
//{
...
//}
//
//// These are more or less the same as above
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onResumeNative( JNIEnv * env, jobject obj, jlong handle )
//{
//    ALOGV( "    GLES3JNILib::onResume()" );
//    ovrAppThread * appThread = (ovrAppThread *)((size_t)handle);                                    // we should test whether this would work without the size_t
//    ovrMessage message;
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onPauseNative( JNIEnv * env, jobject obj, jlong handle )
//{
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onStopNative( JNIEnv * env, jobject obj, jlong handle )
//{
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onDestroyNative( JNIEnv * env, jobject obj, jlong handle )
//{
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onSurfaceCreatedNative( JNIEnv * env, jobject obj,
...
//        // manifest. The choreographer callback will also never be called for this surface because
//        // The surface is immediately replaced with a new surface with the correct orientation.
//        ALOGE( " Surface not in landscape model! ");
//    }
//    ALOGV( "        NativeWindow = ANativeWIndow_fromSurface( env, surface )" );
//    appThread->NativeWindow = newNativeWindow;
//    ovrMessage message;
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onSurfaceChangedNative( JNIEnv * env, jobject obj, jlong handle, jobject surface )
//{
...
//
//JNIEXPORT void JNICALL
//Java_com_chymeravr_graphicssdkgearvr_ActivityGearVR_onSurfaceDestroyedNative( JNIEnv * env, jobject obj, jlong handle )
//{
...
//*/
//
////JNIEXPORT void JNICALL Java_com_chymeravr_ovr_1sdk_1test_GLES3JNILib_onKeyEvent( JNIEnv * env, jobject obj, jlong handle, int keyCode, int action )
////{
...
////}
////
////JNIEXPORT void JNICALL Java_com_chymeravr_ovr_1sdk_1test_GLES3JNILib_onTouchEvent( JNIEnv * env, jobject obj, jlong handle, int action, float x, float y )
////{
