...
const std::string TAG = "TestGraphicsSDKNative";

JNIEXPORT void JNICALL
Java_com_chymeravr_testgraphicssdk_MyGLRenderer_DrawFrameNative(JNIEnv *env,
                                                                         jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_chymeravr_testgraphicssdk_MyGLRenderer_SurfaceCreatedNative(JNIEnv *env,
                                                                              jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_chymeravr_testgraphicssdk_MyGLRenderer_SurfaceChangedNative(JNIEnv *env,
                                                                     jobject instance,
                                                                     jint width,
                                                                     jint height) {
