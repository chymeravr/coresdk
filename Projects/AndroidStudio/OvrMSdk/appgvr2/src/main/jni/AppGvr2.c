...
static bool ovrProgram_Create(ovrProgram *program, const char *vertexSource,
                              const char *fragmentSource, const bool useMultiview) {
    GLint r;
...
static void ovrScene_Create(ovrScene *scene, bool useMultiview) {
    ...
    GL(glBufferData(GL_UNIFORM_BUFFER, 2 * sizeof(ovrMatrix4f) /* 2 view matrices */ +
                                       sizeof(ovrMatrix4f) /* 1 projection matrix*/,
                    NULL, GL_STATIC_DRAW));
...
static ovrFrameParms ovrRenderer_RenderFrame(ovrRenderer *renderer, const ovrJava *java,
    ...
    for (int eye = 0; eye < renderer->NumBuffers; eye++) {
        ...
        if (scene->Program.UniformLocation[UNIFORM_VIEW_ID] >=
            0)  // NOTE: will not be present when multiview path enabled.
        {
...
static void ovrApp_PushBlackFinal(ovrApp *app, const ovrPerformanceParms *perfParms) {
    ...
    ovrRenderThread_Submit( &app->RenderThread, app->Ovr,
            ...
            NULL, NULL, NULL );
#else
    ovrFrameParms frameParms = vrapi_DefaultFrameParms(&app->Java, VRAPI_FRAME_INIT_BLACK_FINAL,
                                                       vrapi_GetTimeInSeconds(), NULL);
...
static void ovrApp_BackButtonAction(ovrApp *app, const ovrPerformanceParms *perfParms) {
    ...
    else if (app->BackButtonState == BACK_BUTTON_STATE_PENDING_SHORT_PRESS &&
             !app->BackButtonDown) {
    ...
    if (keyCode == AKEYCODE_BACK) {
        if (action == AKEY_EVENT_ACTION_DOWN) {
            if (!app->BackButtonDown) {
                if ((vrapi_GetTimeInSeconds() - app->BackButtonDownStartTime) <
                    vrapi_GetSystemPropertyFloat(&app->Java,
                                                 VRAPI_SYS_PROP_BACK_BUTTON_DOUBLETAP_TIME)) {
...
void *AppThreadFunction(void *parm) {
    ...
    appState.UseMultiview &= (glExtensions.multi_view &&
                              vrapi_GetSystemPropertyInt(&appState.Java,
        ...
        for (; ;) {
            ...
            switch (message.Id) {
                ...
                case MESSAGE_ON_TOUCH_EVENT: {
                    ovrApp_HandleTouchEvent(&appState,
                                            ovrMessage_GetIntegerParm(&message, 0),
...
JNIEXPORT jlong JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onCreate(JNIEnv *env, jobject obj,
                                                                        jobject activity) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onStart(JNIEnv *env, jobject obj,
                                                                      jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onResume(JNIEnv *env, jobject obj,
                                                                       jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onPause(JNIEnv *env, jobject obj,
                                                                      jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onStop(JNIEnv *env, jobject obj,
                                                                     jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onDestroy(JNIEnv *env, jobject obj,
                                                                        jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onSurfaceCreated(JNIEnv *env,
                                                                               jobject obj,
                                                                               jlong handle,
                                                                               jobject surface) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onSurfaceChanged(JNIEnv *env,
                                                                               jobject obj,
                                                                               jlong handle,
                                                                               jobject surface) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onSurfaceDestroyed(JNIEnv *env,
                                                                                 jobject obj,
                                                                                 jlong handle) {
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onKeyEvent(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL Java_com_chymeravr_appgvr2_GLES3JNILib_onTouchEvent(JNIEnv *env, jobject obj,
