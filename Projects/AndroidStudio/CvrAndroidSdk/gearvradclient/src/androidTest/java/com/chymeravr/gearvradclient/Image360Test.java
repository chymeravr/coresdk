...
import static com.chymeravr.gearvradclient.TestUtils.createDoB;
import static com.chymeravr.gearvradclient.TestUtils.createLocation;
...
public class Image360Test {
    ...
    public void setUp() throws Exception {
        ...
        this.image360Ad = new Image360Ad(appContext, new VrAdListener() {
            @Override
            public void onAdLoaded() {
            }

            @Override
            public void onAdLoadFailed(VrAdRequest.Error errorReason, String additionalErrorInfo) {
...
//    }
    ...
    public void onLoadTest() throws Exception {
        ...
        Date dob = createDoB();
        VrAdRequest vrAdRequest = VrAdRequest.builder()
                .location(location)
                .birthday(dob)
                .gender(VrAdRequest.Gender.MALE).build();

        this.image360Ad.loadAd(vrAdRequest);
//        Thread.sleep(5000);
