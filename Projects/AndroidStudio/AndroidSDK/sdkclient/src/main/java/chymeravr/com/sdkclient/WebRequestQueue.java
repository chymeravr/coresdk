...
//    }
//
//    public static synchronized void setInstance(VolleyRequestQueue requestQueue){
//        if(mInstance == null){
//            mInstance = requestQueue;
//        }
//    }
//
...
//                });
    ...
    public static synchronized void setInstance(WebRequestQueue requestQueue){
        if(mInstance == null){
            mInstance = requestQueue;
        }
    }
