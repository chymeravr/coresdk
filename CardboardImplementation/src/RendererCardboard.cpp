...
RendererCardboard::RendererCardboard(gvr_context *gvr_context, ILoggerFactory *loggerFactory) : gvr_api_(gvr::GvrApi::WrapNonOwned(gvr_context)),
...
void RendererCardboard::stop()
{
}

void RendererCardboard::pause()
{
    gvr_api_->PauseTracking();
}

void RendererCardboard::resume()
{
