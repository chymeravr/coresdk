...
RendererDaydream::RendererDaydream(gvr_context *gvr_context, ILoggerFactory *loggerFactory) : gvr_api_(gvr::GvrApi::WrapNonOwned(gvr_context)),
...
void RendererDaydream::draw(Scene *scene, EYE eye)
{
    TransformTreeCamera *transform = (TransformTreeCamera *)this->renderCamera->getComponentList().getComponent(
        "transformTree");
